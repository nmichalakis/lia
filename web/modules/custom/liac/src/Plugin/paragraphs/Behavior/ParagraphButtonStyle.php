...
/**
 * @ParagraphsBehavior(
 *   id = "liac_paragraph_button_style",
 *   label = @Translation("Buttons Style"),
 *   description = @Translation("Allows to define paragraph buttons style."),
 *   weight = 0,
 * )
 */
class ParagraphButtonStyle extends ParagraphsBehaviorBase {
  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    $form['paragraph_style'] = [
      '#type' => 'select',
      '#title' => $this->t('Paragraph Buttons Style'),
      '#options' => $options,
  ...
  public function settingsSummary(Paragraph $paragraph) {
    ...
    if (!empty($paragraph_style)) {
      $summary[] = $this->t('Paragraph Buttons Style: @value', ['@value' => $this->getOptionLabel($paragraph_style)]);
    }
    else {
