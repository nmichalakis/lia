...
/**
 * @ParagraphsBehavior(
 *   id = "liac_paragraph_header_style",
 *   label = @Translation("Header Style"),
 *   description = @Translation("Allows to define paragraph header style."),
 *   weight = 0,
 * )
 */
class ParagraphHeaderStyle extends ParagraphsBehaviorBase {
  ...
  public function view(array &$build, Paragraph $paragraph, EntityViewDisplayInterface $display, $view_mode) {
    ...
    $build['#attributes']['class'][] = 'paragraph--header__' . ($paragraph_style ?: 'default');
  }
  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    ...
    $form['paragraph_style'] = [
      '#type' => 'select',
      '#title' => $this->t('Paragraph Header Style'),
      '#options' => $options,
  ...
  public function settingsSummary(Paragraph $paragraph) {
    ...
    if (!empty($paragraph_style)) {
      $summary[] = $this->t('Paragraph Header Style: @value', ['@value' => $this->getOptionLabel($paragraph_style)]);
    }
    else {
